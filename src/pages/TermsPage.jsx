  ...
  return (
    <PageLayout>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <p>본 약관은 데이와이즈(이하 "회사")가 제공하는 모바일 청첩장 제작 서비스 및 관련 제반 서비스의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
      </section>

      <section style={{ marginBottom: '30px' }}>
        <h2 style={{ fontSize: '1.3rem', marginBottom: '16px', color: '#000' }}>제 2 조 (회원의 의무)</h2>
      ...
      <section style={{ marginBottom: '30px' }}>
        <h2 style={{ fontSize: '1.3rem', marginBottom: '16px', color: '#000' }}>제 3 조 (서비스의 제공 및 변경)</h2>
        <p>회사는 안정적인 서비스 제공을 위해 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신두절 또는 운영상 상당한 이유가 있는 경우 서비스의 제공을 일시적으로 중단할 수 있습니다.</p>
      </section>
      
      <section style={{ marginBottom: '30px' }}>
        <h2 style={{ fontSize: '1.3rem', marginBottom: '16px', color: '#000' }}>제 4 조 (게시물 및 데이터 관리)</h2>
        <p>① 회원이 작성하거나 업로드한 콘텐츠(사진, 텍스트, 주소 등)에 대한 모든 책임은 전적으로 회원 본인에게 있으며, 회사는 이에 대해 어떠한 보증이나 책임도 지지 않습니다.</p>
        <p>② 회원의 콘텐츠가 제3자의 저작권, 초상권 등 기타 권리를 침해하는 경우, 이로 인해 발생하는 모든 민·형사상 법적 책임은 회원이 전적으로 부담하며 회사는 면책됩니다.</p>
        <p>③ 회사는 서비스 운영상 필요하다고 판단되는 경우, 회원의 사전 동의 없이 업로드된 콘텐츠를 삭제하거나 서비스 이용을 제한할 수 있으며, 이로 인한 데이터 손실에 대해 어떠한 보상이나 책임도 지지 않습니다.</p>
      </section>

      <section style={{ marginBottom: '30px' }}>
        <h2 style={{ fontSize: '1.3rem', marginBottom: '16px', color: '#000' }}>제 5 조 (면책조항 및 손해배상)</h2>
        <p>① 회사는 서비스를 "있는 그대로(AS-IS)" 제공하며, 서비스의 무결성, 신뢰성, 특정 목적에의 적합성 등을 묵시적으로도 보증하지 않습니다.</p>
        <p>② 회사는 천재지변, 전쟁, 기간통신사업자의 서비스 중지, 서버 장애, 해킹 및 기타 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없거나 데이터가 유실된 경우 서비스 제공에 대한 책임이 완전히 면제됩니다.</p>
        <p>③ 회사는 회원의 귀책사유나 네트워크 환경 문제로 인한 서비스 이용 장애에 대하여 책임을 지지 않습니다.</p>
        <p>④ 서비스 이용과 관련하여 회원에게 발생한 어떠한 직·간접적, 징벌적, 파생적 손해에 대해서도 회사는 법적 책임을 지지 않으며, 회원이 감수해야 합니다.</p>
      </section>
