  ...
  if (textStyle === 'style2') {
    return (
      <div style={{ ...containerStyle, textAlign: 'left', padding: '60px 30px' }}>
        ...
        <FadeUp active={optionInfo.motionEffect} delay={optionInfo.cinematicIntro ? '4.5s' : '0s'} isFirst={true}>
        ...
        <FadeUp active={optionInfo.motionEffect} delay={optionInfo.cinematicIntro ? '5.0s' : '0s'} isFirst={true}>
